...
const ArticlesPage = ({ articles }) => {
  ...
  return (
    <>
      ...
      <p className={styles.pFeedly}>
        <img className={styles.imageFeedly} src="/veilles/feedly.jpg" alt="Mon feed Feedly" /><br />
        (capture d'écran de mon compte Feedly)
      </p>
    </>
  );
};
